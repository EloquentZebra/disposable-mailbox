    ...
    <script>
        ...
        setInterval(function () {
            ...
            r.onreadystatechange = function () {
                ...
                if (r.responseText > 0) {
                    console.log("Im Postfach hat es", r.responseText, "neue E-Mails.");
...
<div id="new-content-avalable">
    <div class="alert alert-info alert-fixed" role="alert">
        <strong>Neue E-Mail</strong> erhalten.
        ...
        <div class="row" id="address-box-normal">
            ...
            <div class="col get-new-address-col">
                <button type="button" class="btn btn-outline-dark"
                    ...
                    <i class="fas fa-magic"></i> E-Mail-Adresse ändern
                </button>
            </div>
        </div>
                ...
                <div class="card-body">
                    <p>
                        <a href="?action=random" role="button" class="btn btn-dark">
                            ...
                            Zufälliges Postfach öffnen
                        </a>
                    </p>


                    oder erstelle deine eigene E-Mail-Adresse:
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-auto my-1">
                            <button type="submit" class="btn btn-primary">Postfach öffnen</button>
                        </div>
                    </div>
        ...
        <div id="email-list" class="list-group">
            ...
            if (empty($emails)) {
                ...
                <div id="empty-mailbox">
                    <p>Das Postfach ist leer. Es wird regelmässig auf neue E-Mails geprüft. </p>
                    <div class="spinner">
                        <div class="rect1"></div>
                        <div class="rect2"></div>
                        <div class="rect3"></div>
